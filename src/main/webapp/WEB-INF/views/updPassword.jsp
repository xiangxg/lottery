...
<form id="addform" action="save.do" method="post">
   ...
   <table cellpadding="5" id="searchWin">
            ...
            <tr>
                <td>是否启动:</td>
                <td><input class="easyui-combobox" type="text" name="isStart" style="width:250px;" data-options="valueField:'id',textField:'text',data:[{text:'true',id:true},{text:'false',id:false}]"></input></td>
            </tr>
            <tr>
                <td>备注:</td>
